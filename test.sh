...
doPass "several layers deep"    '[[[[1]]]]'            [0][0][0][0]:1
doPass "several builders deep"  '[[[[1]]]]'            [ [ [ [ 1 ] ] ] ]
echo
...
doFail "cannot close object builder; none to close"       }
doFail "cannot close object builder; in array builder"    [ }
doFail "array builder is unclosed"                        [
doFail "cannot close array builder; none to close"        ]
doFail "cannot close array builder; in object builder"    { ]
doFail "items in an object require a key and value"       a
doFail "items in an object require a key and value"       'a\:b'
doFail "items in an object require a key and value"       { [ ] }
doFail "items in an object require a key and value"       { { } }
doFail "items in an array may not have a key"             [ a:1 ]
doFail "items in an array may not have a key"             [ a{ b:1 } ]
doFail "items in an array may not have a key"             [ a[ 0 ] ]
